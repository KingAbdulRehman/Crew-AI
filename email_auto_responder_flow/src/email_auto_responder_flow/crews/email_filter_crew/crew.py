...
from email_auto_responder_flow.tools.custom_tool import GmailFetcherTool, GmailDrafterTool
...
class EmailFilterCrew():
	...
	def draft_responses(self) -> Task:
		return Task(
			...
			output_file='email_responses.md'
		)

	@crew
	def crew(self) -> Crew:
		"""Creates the EmailFilterCrew crew"""
